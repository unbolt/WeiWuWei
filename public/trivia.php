...
$WOW_TRIVIA_ANSWERS1[117] = "Bonescythe";
...
$WOW_TRIVIA_ANSWERS1[452] = "Grand Marshal";
$WOW_TRIVIA_ANSWERS2[452] = "14";
...
$WOW_TRIVIA_QUESTIONS[462] = "Kel'Thuzad was killed by adventurers who entered Naxxramas. (True/False)?";
...
foreach($WOW_TRIVIA_QUESTIONS AS $KEY => $VALUE) {
    echo $VALUE;

    if($WOW_TRIVIA_ANSWERS1[$KEY]) {
        echo '`'.$WOW_TRIVIA_ANSWERS1[$KEY];
    }
    if($WOW_TRIVIA_ANSWERS2[$KEY]) {
        echo '`'.$WOW_TRIVIA_ANSWERS2[$KEY];
    }
    if($WOW_TRIVIA_ANSWERS3[$KEY]) {
        echo '`'.$WOW_TRIVIA_ANSWERS3[$KEY];
    }
    if($WOW_TRIVIA_ANSWERS4[$KEY]) {
        echo '`'.$WOW_TRIVIA_ANSWERS4[$KEY];
    }
    if($WOW_TRIVIA_ANSWERS5[$KEY]) {
        echo '`'.$WOW_TRIVIA_ANSWERS5[$KEY];
    }
    if($WOW_TRIVIA_ANSWERS6[$KEY]) {
        echo '`'.$WOW_TRIVIA_ANSWERS6[$KEY];
    }
    if($WOW_TRIVIA_ANSWERS7[$KEY]) {
        echo '`'.$WOW_TRIVIA_ANSWERS7[$KEY];
    }
    echo '<br/>';
}
